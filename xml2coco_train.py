...
def main():
    xml_path = '/content/mask_rcnn_train/dataset/train/xml' #xml
    print('xml_path: ', xml_path)
    # xml_path = '../../../Datasets/underwater/data0/18test/label'
    img_path = '/content/mask_rcnn_train/dataset/train/images' #img
    # img_path = '../../../Datasets/underwater/data0/18test/image'
    print('processing {} ...'.format("xml format annotations"))
    cvt_annotations(img_path, xml_path, '/content/mask_rcnn_train/dataset/train/annotations.json')  # json
