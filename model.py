...
class MeanAveragePrecisionCallback(Callback):
        def __init__(self, train_model: MaskRCNN, inference_model: MaskRCNN, dataset: CustomDataset,
...
class MaskRCNN():
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers,
              augmentation=None, custom_callbacks=MeanAveragePrecisionCallback, no_augmentation_sources=None):
        """Train the model.
